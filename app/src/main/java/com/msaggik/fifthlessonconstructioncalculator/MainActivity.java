        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.buttonDrywall:
                    ...
                    Intent intentDrywall = new Intent(getApplicationContext(), DrywallActivity.class); // создание намерения переключения в активность калькулятора обоев
                    startActivity(intentDrywall);
